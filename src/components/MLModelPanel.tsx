    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                 <Card>
                    <h3 className="text-lg font-semibold mb-4 text-green-400">💡 Топ прибыльных паттернов</h3>
                        ...
                        <table className="min-w-full text-sm">
                            <thead className="border-b border-gray-700">
                                <tr>
                                    ...
                                    <th className="py-2 text-center">Ставок</th>
                                </tr>
                            </thead>
                            <tbody>
                                {topPatterns.map(p => (
                 ...
                 <Card>
                    <h3 className="text-lg font-semibold mb-4 text-red-400">⚠️ Самые убыточные паттерны</h3>
                    <div className="overflow-x-auto">
                        <table className="min-w-full text-sm">
                            <thead className="border-b border-gray-700">
                                <tr>
